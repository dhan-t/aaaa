...
export declare class AudioNative {
     ...
     *     })
     */
    create(file: File | fs.ReadStream, request: ElevenLabs.BodyCreatesAudioNativeEnabledProjectV1AudioNativePost, requestOptions?: AudioNative.RequestOptions): Promise<ElevenLabs.AudioNativeCreateProjectResponseModel>;
}
